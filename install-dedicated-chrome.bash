...
if [ -f ~/Downloads/google-chrome-stable_109.0.5414.74-1_amd64.deb ]; then
    ...
    sudo wget -q --show-progress --output-document=$HOME/Downloads/google-chrome-stable_amd64.deb https://dl.google.com/linux/chrome/deb/pool/main/g/google-chrome-stable/google-chrome-stable_109.0.5414.74-1_amd64.deb
else 
